...
class LogisticRegressor:
    ...
    def loss(self, *args):
        ...
        J = np.mean( -y*np.log(utils.sigmoid(theta@X.T)) - (1-y)*np.log(1-utils.sigmoid(theta@X.T)) )
    ...
    def grad_loss(self, *args):
        ...
        grad = 1/m*(utils.sigmoid(theta@X.T) - y)@X
    ...
    def predict(self, X):
        ...
        y_pred = utils.sigmoid(self.theta@X.T)
...
class RegLogisticRegressor:
    ...
    def predict(self, X):
        ...
        #                                                                         #
        ###########################################################################
        y_pred = 1*( utils.sigmoid(self.theta@X.T) > 0.5 )
